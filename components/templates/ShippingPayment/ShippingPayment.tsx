			...
			<div className={'container'}>
				...
				<div className={`${styles.shipping_payment__tabs} ${darkModeClass}`}>
					<ul className={styles.shipping_payment__tabs__controls}>
						...
						>
							<button onClick={handleTab1} className={darkModeClass}>
						...
						>
							<button onClick={handleTab2} className={darkModeClass}>
						...
						>
							<button onClick={handleTab3} className={darkModeClass}>
						...
						>
							<button onClick={handleTab4} className={darkModeClass}>
